const pcsMessageBox = (function () {
  ...
  return function (msg, modal, buttons, callback = () => {}) {
    ...
    if (buttons && buttons.length > 0) {
      buttons.forEach( button=> {
        const buttonThing = document.createElement('button');
        buttonThing.innerText = button;
        buttonThing.style.margin = '5px';
...
buttonDiv.appendChild(buttonThing);
      });
    }
    else {
